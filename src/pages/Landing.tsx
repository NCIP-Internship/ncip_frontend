...
const carouselData = [
  {
    ...
    subText: "The Rights of Indigenous Cultural Communities and Authenticity and Ethnicity as an Indigenous People. (COC)",
    btnLabel: "Apply now"
  },
  {
  ...
  },
  {
    ...
    subText: "Creating a Legislative Agenda in a Partnership with the Community that represent.",
            ...
            <div className="flex flex-col justify-center items-center ">
              ...
              <div className="flex flex-col items-center justify-center my-32">
                ...
                <div className="my-8 flex gap-4">
                  <Button variant="outline" className="font-semibold">{btnLabel}</Button>
                  <Button variant="link" className="text-white font-semibold">See FAQs'</Button>
                </div>
              </div>
...
const CarouselComponent = () => {
  ...
  return(
    <Carousel className="w-full h-full flex  items-center justify-center" plugins={[plugin.current]} onMouseEnter={plugin.current.stop}
