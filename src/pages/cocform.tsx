    ...
    <>
      ...
      <form>
        ...
        <div className="mb-6">
          ...
          <select id="Sex" name="Sex" className="mt-1 block w-full p-2 border border-gray-300 rounded-md">
          ...
          <option value=""disabled>Civil Status</option>
            ...
            <input type="text" placeholder="Address" className="p-2 border border-gray-300 rounded-md" />
            <input type="text" placeholder="Place of Birth" className="p-2 border border-gray-300 rounded-md" />
            <input type="text" placeholder="Tribe" className="p-2 border border-gray-300 rounded-md" />

            <label htmlFor="dob" className="mt-2 text-xl">Date of Birth</label>
            ...
            <input type="text" placeholder="Tribe" className="p-2 border border-gray-300 rounded-md col-span-2" />
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <h2 className="text-lg font-bold mb-5">Parental Background</h2>
            ...
            <div className="grid grid-cols-2 gap-4 mt-2">
              ...
              <input type="text" placeholder="IP Group" className="p-2 border border-gray-300 rounded-md" />

              <input id="father-origin" type="text" placeholder="Place of Origin" className="p-2 border border-gray-300 rounded-md" />
              <div></div>

              <input type="text" placeholder="Grandfather's Name" className="p-2 border border-gray-300 rounded-md" />
              <input type="text" placeholder="IP Group" className="p-2 border border-gray-300 rounded-md" />

              <input type="text" placeholder="Grandmother's Name" className="p-2 border border-gray-300 rounded-md" />
              <input type="text" placeholder="IP Group" className="p-2 border border-gray-300 rounded-md" />
              ...
              <input id="mother-origin" type="text" placeholder="Place of Origin" className="p-2 border border-gray-300 rounded-md" />
              <div></div>
