  ...
  return (
    <>
      ...
      <section className="flex flex-col text-left px-5 sm:px-8 md:px-10 lg:px-12 ml-10 sm:ml-20 md:ml-30 lg:ml-40 mr-10 sm:mr-20 md:mr-30 lg:mr-40 pb-20 sm:pb-30 md:pb-40 lg:pb-50 font-primary">
        ...
        <h6 className="font-bold text-base md:text-lg flex flex-col justify-center items-center lg:pt-20">NCIP Administrative Order No. 01 Series of 2022</h6>
        <h4 className="font-semibold text-xl md:text-4xl flex flex-col justify-center items-center mt-2">2021 Revised National Guidelines for the Mandatory Representation of Indigenous Peoples in Local Legislative Councils and Policy-making Bodies</h4>
