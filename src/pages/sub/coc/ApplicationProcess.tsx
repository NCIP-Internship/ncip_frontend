...
export const ApplicationProcess = () => {
  return (
    <>
      <Navbar />
      <section className="flex flex-col text-left px-5 md:px-10 lg:px-20">
        <h1 className="font-bold text-3xl lg:text-5xl flex flex-col justify-center items-start pt-12 lg:pt-20">
          Application Process
        </h1>
        <h3 className="font-medium text-gray-600 text-lg lg:text-xl flex flex-col justify-center items-start  pt-5">
          Navigate through the essential steps for applying for Authenticity and
          Ethnicity as an Indigenous People.{" "}
        </h3>
