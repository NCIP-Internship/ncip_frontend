  ...
  return (
    <>
      <nav className="bg-primary sticky top-0 z-50 w-full max-h-24 h-auto p-4 lg:p-8 flex items-center justify-between lg:justify-around">
        ...
        <ul className="hidden lg:flex text-white gap-10 lg:gap-20">
        ...
        <Button
          variant="outline"
          className="hidden lg:block font-Inter border-2 px-4 lg:px-6 py-1 lg:py-2 rounded-full text-white bg-white-500 shadow-md hover:text-black hover:bg-white"
        >
          Sign In
        </Button>
        <MobileNavbar />
