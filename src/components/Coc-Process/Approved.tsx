    ...
    return (
        ...
        <div className="flex flex-col pb-10 md:flex-row-reverse">
            ...
            <div className="flex flex-col w-30 md:w-full ">
                    <h1 className="font-bold text-2xl pl-3 pt-3 md:pl-20 md:pt-10 lg:text-5xl">LIBRARY OF APPROVED COC</h1>
                    <h3 className="font-medium text-sm pl-3 pt-2 md:pl-20 md:pt-5 lg:text-xl">These are the List of Approved COC</h3>
                <div className="flex flex-col pl-3 pr-3 md:pl-20 md:pr-60 lg:pr-96 relative mt-5">
